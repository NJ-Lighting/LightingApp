...
export function renderHeader(active){
  // Pas tabs aan je werkelijke pagina's aan
  const tabs = [
    {id:'addr',  href:'addressing.html',  label:'Bulk Addressing'},
    {id:'dip',   href:'dipswitch.html',   label:'DIP-Switch'},
    // {id:'lib',   href:'library.html',     label:'Fixture Library'}, // optioneel, als je later een pagina maakt
